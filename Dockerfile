...
RUN pip3 install schedule pandas psycopg2-binary csvkit requests flask redis rq tx-functional git+https://github.com/vaidik/sherlock.git@77742ba91a24f75ee62e1895809901bde018654f
