...
# POSTGRES_DUMP_PATH
# build TIC preprocessing-assembly-0.1.0.jar from https://github.com/RENCI/map-pipeline/tree/0.1.0
...
FROM ubuntu:18.04
COPY ["TIC preprocessing-assembly-0.1.0.jar", "TIC preprocessing-assembly.jar"]
