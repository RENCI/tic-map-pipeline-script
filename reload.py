    ...
    with open(tfname, "r", newline="", encoding="latin-1") as tfi:
        ...
        try:
            ...
            if not global_write_permissions:
                ...
                global_write_permissions = global_write_permissions.lower().split(",")
            if ((tablename.lower() == "studysites" and len(seen) < 4) or tablename.lower() == "ctsas") and (user.lower() not in global_write_permissions or not user):
